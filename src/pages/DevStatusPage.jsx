...
const MODULES = [
  ...
  {
    id: 'syllabus_plan',
    name: 'Syllabus Plan IA',
    icon: '🧠',
    category: 'core',
    progress: 70,
    status: 'active',
    summary: 'Motor de planificación curricular por período. El docente carga la malla, configura unidades por período y slots recurrentes, la IA distribuye el cronograma semana×día.',
    works: [
      'syllabus_plan tabla con JSONB: units, recurring_slots, distribution',
      'computeWorkingWeeks(): semanas hábiles excluyendo no_class del school_calendar',
      'distributeSyllabusAI(): distribución curricular IA → cronograma semana×día',
      'parseCurriculumAI(): malla curricular en texto → unidades estructuradas',
      'SyllabusPlanView.jsx: UI completa (malla, slots, distribución, publicar)',
      'useSyllabusPlan hook: CRUD plan + saveDistribution + publishDistribution',
      'Pipeline Syllabus → Guía: syllabusTopics fluye a generateGuideStructure',
      'Per-period week numbering: getPeriodWeek() reemplaza getSchoolWeek()',
      'classResolver: matching por monday_date en vez de week_number',
    ],
    pending: [
      'Validación avanzada de recurring_slots (conflictos, límites)',
      'Refinamiento del prompt de distributeSyllabusAI para distribuciones más equilibradas',
      'Testing end-to-end: syllabus → distribución → publicación → guía generada',
      'UI para editar distribución manualmente post-IA (drag & drop)',
    ],
    history: [
      { date: '2026-05-16', reason: 'Sprint completo A-B', detail: 'Tabla syllabus_plan, hook useSyllabusPlan, syllabusAI.js (compute+distribute+parse), SyllabusPlanView UI, pipeline syllabus→guía (GuideEditorPage→ConversationalGuideModal→generateGuideStructure).' },
      { date: '2026-05-16', reason: 'Per-period week numbering', detail: 'getPeriodWeek() en dateUtils.js. PlannerPage usa semanas relativas al inicio del período. classResolver usa monday_date para matching confiable.' },
    ],
  },
  {
    id: 'security',
