...
const MODULES = [
  ...
  },
  {
    ...
    progress: 99,
    status: 'active',
    summary: '3 modos de evaluación (Dictation/Vocabulary Quiz/Combined) con 5 tipos de pregunta. TTS automático + IA generadora + antitrampa + corrección instantánea + Telegram. Sala de Control con 3 paneles RT, advertencias push, force-close remoto, timeline de violaciones.',
    works: [
      ...
      'ManualEntryForm: 5 secciones — listen_type, listen_identify, matching, fill_blank, writing',
    ...
    pending: [
      'CorrectedExamView: modal con respuestas correctas/incorrectas por pregunta',
      'exportDictationResultHtml: PDF corregido con header CBF-G AC-01',
      'send-result-email Edge Fn: envío a representative_email via Resend',
