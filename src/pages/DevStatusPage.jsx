...
const MODULES = [
  ...
  },
  {
    ...
    progress: 97,
    status: 'active',
    summary: '3 modos de evaluación (Dictation/Vocabulary Quiz/Combined) con 5 tipos de pregunta. TTS automático + IA generadora + antitrampa + corrección instantánea + Telegram. Modo manual, biblioteca de vocabulario, export audio/PDF dinámico, archivo de dictados.',
    works: [
      'DictationPage: shell de tabs → 8 componentes extraídos en src/components/dictation/',
      'CreateTab: wizard 3 pasos con modo IA y modo manual (toggle entryMode) + assessmentMode selector',
      '3 modos de evaluación: Dictation (audio TTS), Vocabulary Quiz (text-based), Combined (full)',
      '5 tipos de pregunta: listen_type, listen_identify, matching, fill_blank, writing',
      ...
      'scoreDictation(): soporta 5 tipos — Levenshtein (typed), exact match (MC), vocab coverage (writing)',
      'ManualEntryForm: 5 secciones — listen_type, listen_identify, matching (word→4 defs), fill_blank, writing (prompt+words)',
      ...
      'ListTab: biblioteca de dictados — filtros, detalle expandible, reusar sesión, archivar/restaurar',
      ...
      'dictationAI.js: generateDictation() — prompt dinámico por assessmentMode, genera 5 tipos',
    ...
    pending: [
      'Panel post-publish con link copiable para enviar dictado a estudiantes',
