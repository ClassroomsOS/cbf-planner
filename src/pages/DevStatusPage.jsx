...
const MODULES = [
  ...
  },
  {
    ...
    works: [
      ...
      'DictationPlayerPage: volumen independiente por pregunta de audio (slider + icono dinámico 🔇/🔈/🔉/🔊)',
      ...
      'dictation-send-codes Edge Function: un email por estudiante con código + URL visible',
      'dictation-send-test Edge Function: prueba a correos del docente + instancia TEST- reutilizable',
