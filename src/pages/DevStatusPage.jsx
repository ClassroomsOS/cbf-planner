...
const MODULES = [
  ...
  },
  {
    ...
    progress: 95,
    status: 'active',
    summary: 'Dictados con TTS automático + IA generadora + antitrampa + corrección instantánea + Telegram. Modo manual, biblioteca de vocabulario, export audio/PDF, archivo de dictados.',
    works: [
      'DictationPage: shell de tabs → 5 componentes extraídos en src/components/dictation/',
      'CreateTab: wizard 3 pasos con modo IA y modo manual (toggle entryMode)',
      'ManualEntryForm: entrada manual de oraciones por sección (listen_type, listen_identify, fill_blank)',
      ...
      'exportDictationHtml.js: export PDF con header institucional CBF-G AC-01 "LISTENING ASSESSMENT"',
      ...
      'buildManualSectionsScaffold(): scaffold vacío según DIFFICULTY_CONFIG para modo manual',
    ],
    pending: [
