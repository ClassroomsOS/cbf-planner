...
const SECTIONS = [
  { key: 'subject',    label: 'TOPICS',              hex: 'C0504D', time: '~8 min'  },
  { key: 'motivation', label: 'SUBJECT TO BE WORKED', hex: '4F81BD', time: '~7 min'  },
  { key: 'activity',   label: 'MOTIVATION',           hex: 'F79646', time: '~10 min' },
  { key: 'skill',      label: 'SKILL DEVELOPMENT',    hex: '8064A2', time: '~25 min' },
  { key: 'assignment', label: 'ASSIGNMENT',            hex: '4BACC6', time: '~3 min'  },
  { key: 'closing',    label: 'CLOSING',               hex: '9BBB59', time: '~5 min'  },
]
