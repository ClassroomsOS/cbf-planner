// ── SmartBlock HTML utilities ─────────────────────────────────────────────────
// Pure JS — no React, no state. Used by SmartBlocks.jsx (preview), exportHtml.js,
// and any future consumer that needs HTML output from block data.
...
export function normalizeVocabWords(data) {
